  ...
  <div class="container-fluid">
    ...
    <div class="row-fluid">
        ...
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>员工列表</h5>
          <div class="buttons">
          	<a title="添加员工" class="btn btn-mini" href="<?php echo U('Role/role_add');?>"><i class="icon-plus"></i></a>
          </div>
        </div>
          ...
          <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                <td><?php echo ($vo["remark"]); ?></td>
                  <td>
                  <a   class="btn btn-info" href="<?php echo U('Role/role_access',array('id'=>$vo['id']));?>"
                      <i class="icon-edit icon-white"></i>
                        权限管理
                    </a>
                    <a   class="btn btn-info" href="<?php echo U('Title/title_add',array('id'=>$vo['id']));?>"
                      <i class="icon-edit icon-white"></i>
                        成员管理
                    </a>
                  	<a   class="btn btn-info" href="<?php echo U('Title/title_add',array('id'=>$vo['id']));?>"
 ...
 $(function(){
    $(".btn-danger").click(function(){
        ...
        var d=dialog({
            ...
            okValue:"确定",
            ok:function(){
                $.post("/luomanage1/index.php?s=/Home/Role/del_title",{id:id},function(data){
                    var s=dialog({
                        title:"提示",
                        content:data.msg,
                        width:200,
