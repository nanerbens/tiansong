  ...
  <div class="container-fluid">
    ...
    <div class="row-fluid">
        ...
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>职称列表</h5>
          <div class="buttons">
          	<a title="职称添加" class="btn btn-mini" href="<?php echo U('Title/title_add');?>"><i class="icon-plus"></i></a>
          </div>
        </div>
 ...
 $(function(){
    $(".btn-danger").click(function(){
        ...
        var d=dialog({
            ...
            okValue:"确定",
            ok:function(){
                $.post("/luomanage1/index.php?s=/Home/Title/del_title",{id:id},function(data){
                    var s=dialog({
                        title:"提示",
                        content:data.msg,
                        width:200,
