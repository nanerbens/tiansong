  ...
  <div class="container-fluid">
    ...
    <div class="row-fluid">
        ...
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>部门列表</h5>
          <div class="buttons">
          	<a title="添加部门" class="btn btn-mini" href="<?php echo U('Partment/part_add');?>"><i class="icon-plus"></i></a>
          </div>
        </div>
          ...
          <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                <td><?php echo ($vo["remark"]); ?></td>
                  <td>
                  	<a   class="btn btn-info" href="<?php echo U('Partment/part_add',array('id'=>$vo['id']));?>"  <?php switch($vo["is_delete"]): case "1": break; case "0": ?>style="display:none"<?php break; endswitch;?>>
 ...
 $(function(){
    $(".btn-danger").click(function(){
        ...
        var d=dialog({
            ...
            okValue:"确定",
            ok:function(){
                $.post("/luomanage1/index.php?s=/Home/Partment/del_part",{id:id},function(data){
                    var s=dialog({
                        title:"提示",
                        content:data.msg,
                        width:200,
