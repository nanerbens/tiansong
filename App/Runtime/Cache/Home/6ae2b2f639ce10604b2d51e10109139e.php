...
<script type="text/javascript">
   $(".btn-success").click(function(){
      ...
      $.post("/luomanage1/index.php?s=/Home/Partment/part_add",{id:id,name:name,remark:remark},function(data){
            var d=dialog({
                title:"提示",
                width:200,
                content:data.msg,
                ...
                ok:function(){
                    if(data.status==1){
                      window.location.href="/luomanage1/index.php?s=/Home/Partment/index";
                    }
                }
            })
            d.show();
