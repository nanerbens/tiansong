...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-02-16 00:42:51
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `rs_member` (
  ...
  `remark` varchar(255) NOT NULL COMMENT '基本工资',
  PRIMARY KEY (`id`)
...
(1, 0, 1, 0, 0, '2015-02-15 20:02:49', '127.0.0.1', '田松1', '1106010039', 'e10adc3949ba59abbe56e057f20f883e', '18267720352', '贵州德江1', ''),
(13, 0, 0, 2, 4, '', '', '奥巴马', '1106010031', 'e10adc3949ba59abbe56e057f20f883e', '18267720358', '温州医科大学', ''),
(14, 0, 0, 2, 5, '2015-02-15 20:02:27', '127.0.0.1', '普京', '1106010032', 'e10adc3949ba59abbe56e057f20f883e', '18267720358', '温州医科大学', '');
...
CREATE TABLE IF NOT EXISTS `rs_salary` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kou_salary` int(11) NOT NULL COMMENT '扣款金额',
  `true_salary` int(11) NOT NULL COMMENT '实际工资',
  `mid` int(11) NOT NULL COMMENT '所属员工',
